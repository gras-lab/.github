...
Node.js · Python · Go · React · TypeScript · Next.js · Docker · AWS

---

## Principles

- Code is written once, read many times — clarity is not optional
- Every change is testable and tested
- Dependencies are explicit; side effects are documented
- DRY by default, pragmatic when necessary

---

Alfio Spoto · Gabriele Ruggieri
